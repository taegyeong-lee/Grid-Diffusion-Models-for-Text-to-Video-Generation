...
folder_path = '/home1/grid_images/inter2'
...
for idx_ in tqdm.tqdm(range(order * len(frames)//2, (order + 1) * len(frames)//2, 500)):
    ...
    if os.path.isfile(f'{parquet_folder_path}/sd15_256_2x2_inter2_{index}.parquet'):
        print('file exist')
        continue
    ...
    pq.write_table(table, f'{parquet_folder_path}/sd15_256_2x2_inter2_{index}.parquet')